...
## Current release
- Firefox version: `2.1.18`
- Chrome version: `2.1.19`
...
- Current canonical last-known-good `dist` baselines are:
  - `dist/literotica-downloader-firefox-greasemonkey.user.js` at `2.1.18`
  - `dist/literotica-downloader-chrome-tampermonkey.user.js` at `2.1.19`
