...
- Firefox + Greasemonkey file: `dist/literotica-downloader-firefox-greasemonkey.user.js`
- Chrome + Tampermonkey file: `dist/literotica-downloader-chrome-tampermonkey.user.js`
- Maintained Firefox copy: `userscript/literotica-downloader-firefox-greasemonkey.user.js`
- Maintained Chrome copy: `userscript/literotica-downloader-chrome-tampermonkey.user.js`
