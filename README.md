...
## Current release
- Firefox version: `2.1.12`
- Chrome version: `2.1.13`
...
- Current canonical last-known-good `dist` baselines are:
  - `dist/literotica-downloader-firefox-greasemonkey.user.js` at `2.1.12`
  - `dist/literotica-downloader-chrome-tampermonkey.user.js` at `2.1.13`
